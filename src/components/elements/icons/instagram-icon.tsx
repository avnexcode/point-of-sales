    ...
    >
      <defs>
        ...
        >
          ...
          <stop offset="10%" stopColor="#FF0100" />
          <stop offset="50%" stopColor="#D300C5" />
          <stop offset="100%" stopColor="#200A7A" />
        </radialGradient>
        <radialGradient
        ...
        >
          ...
          <stop offset="10%" stopColor="#FF4458" />
          <stop offset="50%" stopColor="#E757D8" />
          <stop offset="100%" stopColor="#4A5BCC" />
        </radialGradient>
      </defs>
      <path
        fill={
          dark ? "url(#instagram-gradient-dark)" : "url(#instagram-gradient)"
        }
