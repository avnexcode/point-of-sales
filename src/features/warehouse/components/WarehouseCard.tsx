    ...
    >
      ...
      <CardFooter className="pb-6">
        <Button
          ...
          asChild
        >
          <Link href={`/dashboard/warehouse/${id}/view`}>
            {t("components.warehouse.warehouseCard.detailButton")}
          </Link>
        </Button>
      </CardFooter>
    </Card>
...
type WarehouseCardSkeletonProps = {
  className?: string;
};

export const WarehouseCardSkeleton = ({
  className,
}: WarehouseCardSkeletonProps) => {
  return (
    <Card
      className={cn(
